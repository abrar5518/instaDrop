...
export async function POST(request: Request) {
  try {
    ...
    const response = await fetch(`${backendUrl}/payments/paypal/create`, { method: "POST", headers: { "Content-Type": "application/json", Accept: "application/json" }, body, cache: "no-store" });
